...
export class Accept extends Component {
  render() {
    ...
    ? <span>
        You are entering into an agreement with us on the terms and conditions set out in the {link}.
      </span>
    ...
    return (
      <Form onSubmit={handleSubmit} name='accept'>
        ...
        {hasAdditional && <components.Additional additional={fields.additional} />}
